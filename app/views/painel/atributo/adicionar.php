            ...
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">Inserir Atributo</h4>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Cadastrar Atributo</h4>
                                <p class="sub-title">Cadastre um novo atributo.</p>

                                <form id="formInserirAtributo">
